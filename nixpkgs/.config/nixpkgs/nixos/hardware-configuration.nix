...

{
  ...
  fileSystems."/" =
    { device = "/dev/disk/by-uuid/39ecc599-c3fe-4058-a7fa-d759c6079d1d";
      fsType = "ext4";
    };

  fileSystems."/boot" =
    { device = "/dev/disk/by-uuid/AE49-668D";
      fsType = "vfat";
      options = [ "fmask=0022" "dmask=0022" ];
    };

  swapDevices =
    [ { device = "/dev/disk/by-uuid/75d54640-d03d-41b9-8227-84e9de9a8abe"; }
    ];
